...
async function getByPlayer({ playerId, ...params }: GetByPlayerPros) {
  return api
    .get(`${urls.playerOptins.getAll}/player/${playerId}`, { params })
...
async function handleConfirmDelete({
  ...
  // await api.delete(`${urls.playerOptins.delete}/${id}`).then((res) => {
  //     if (successCallBack) {
  //         successCallBack(res)
  //     }
...
async function submitForm(
  ...
  const url = formData?.id ? `${urls.playerOptins.update}/${formData.id}` : urls.playerOptins.create
