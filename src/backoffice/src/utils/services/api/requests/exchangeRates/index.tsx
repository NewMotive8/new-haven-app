...
export interface exchangeRatesI {
...
const defaultItem: exchangeRatesI = {
  id: undefined,
  currentRate: '',
  brand: {},
}
...
async function getItems(params?: pageableProps) {
  return api
    .get(urls.exchangeRates.getAll, { params })
...
async function handleConfirmDelete({
  ...
  await api
    .delete(`${urls.exchangeRates.delete}/${id}`)
    .then((res) => {
      if (successCallBack) {
        successCallBack(res)
      }
