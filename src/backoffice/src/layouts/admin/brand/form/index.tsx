...
export default function BrandForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="Brand-info" />,
            content: <BasicTab />,
        },
        {
            value: 'signature',
            label: <Typography translateGroup="forms-tabs-label" translateKey="signature-info" />,
            content: <SignatureTab />,
            hidden: !selectedItem.id,
        },
        {
            value: 'products',
            label: <Typography>Products</Typography>,
            content: <ProductsTab />,
            hidden: !selectedItem.id,
        },
    ]
    ...
    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'Brand-basic-tab-help', returnDefault: 'nothing' }),
        signature: textTranslated({ group: 'forms-tabs-helpers', key: 'Brand-signature-tab-help', returnDefault: 'nothing' }),
        products: 'Assign catalog products to this brand and manage assignment enabled status.',
    }
