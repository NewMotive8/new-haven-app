...
export default function SegmentsTab() {
    ...
    const { data: segments, isLoading, refetch } = useQuery(`segments-player-${selectedItem.id}`, () => segmentsApi.segmentsPerPlayer(selectedItem.id), {})
