...
import JackpotTab from './tabs/jackpot/jackpot'
...
export default function PlayersForm() {
  ...
  const formTabs: Array<TabSelectorTabI> = [
    ...
    },
    {
      value: 'segments',
      label: (
        <Typography translateGroup="forms-tabs-label" translateKey="segments" />
      ),
      content: <SegmentsTab />,
    },
  ]
