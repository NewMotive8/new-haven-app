...
import playersApi from 'utils/services/api/requests/players'
...
export default function ListCrud() {
  ...
  function handleUploadFile() {
    displayDialog({
      ...
      content: <DialogUpload translateGroup="players-list" />,
    })
  }
  return (
    <>
      <Grid horizontalAlgin="flex-end" margin="mb-3" gap="0.5rem">
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              translateKey="players-upload-list"
              weight={600}
            />
          </Grid>
        </Button>
        <Button
          id="add-item-button"
          onClick={() => {
            setSelectedItem(playersApi.defaultItem)
          }}
          color="primary"
        >
          <Grid
      ...
      <DataGridV3
        ...
        columns={columns}
        dataService={(p) => playersApi.getItems(p)}
        dataGridId={`players-${refreshState}`}
        enablePagination
      />
    </>
  )
