...
export default function TranslationsForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="translations-info" />,
            content: <BasicTab />,
        },
    ]

    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'translations-basic-tab-help', returnDefault: 'nothing' }),
    }
