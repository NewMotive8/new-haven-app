    ...
    return (
        <>
            <Grid horizontalAlgin="flex-end" margin="mb-3">
                <Button id="add-item-button" onClick={() => { setSelectedItem(translationsJPApi.defaultItem) }} color="primary">
                    <Grid wrap="nowrap" gap="0.25rem" horizontalAlgin="center" verticalAlgin="center">
                        <BsPlusCircle />
                        <Typography
                            translateGroup="translations"
                            translateKey="add"
                            weight={600}
                        />
                    </Grid>
            ...
            <DataGridV3
                ...
                columns={columns}
                dataService={(p) => translationsJPApi.getItems(p)}
                dataGridId={`translations-${refreshState}`}
            />
        </>
    )
}
