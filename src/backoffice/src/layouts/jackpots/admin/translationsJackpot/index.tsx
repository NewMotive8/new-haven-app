...
import TranslationsCrudHeader from './header'
...
export default function TranslationsJackpotCrud() {
    const [loading, setLoading] = useState(false)
    const [selectedItem, setSelectedItem] = useState<translationsI | null>(null)
    ...
    function submitForm() {
        setLoading(true)
        translationsJPApi.submitForm(selectedItem?.id ? 'put' : 'post', [selectedItem] as translationsI[], {
            successCallBack: () => {
                askRefresh()
                setSelectedItem(null)
                setLoading(false)
