...
import SeedTransactionsTab from './tabs/seedTransactions'
...
export default function SeedsForm() {
  ...
  const formTabs: Array<TabSelectorTabI> = [
    {
      ...
      label: (
        <Typography
          ...
          translateKey="seeds-info"
        />
      ),
      content: <BasicTab />,
    },
    {
      value: 'seedTransactions',
      label: (
        <Typography
          translateGroup="forms-tabs-label"
          translateKey="seed-transaction"
        />
      ),
      content: <SeedTransactionsTab />,
    },
  ]
  ...
  const tabsHelper: { [key in any]: React.ReactNode } = {
    basic: textTranslated({
      ...
      key: 'seeds-basic-tab-help',
      returnDefault: 'nothing',
    }),
    seedTransactions: textTranslated({
      group: 'forms-tabs-helpers',
      key: 'seeds-seedTransactions-tab-help',
      returnDefault: 'nothing',
    }),
  }
