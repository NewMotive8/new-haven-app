...
import poolTransactionApi from 'utils/services/api/requests/poolTransaction'
...
export default function PoolsTransactionsTab() {
  ...
  const handleGenerateReport = async () => {
    ...
    setLoading(true)
    await exportsApi.generatePoolTransactionsReport(selectedItem.id)
    setLoading(false)
  }
  ...
  return (
    <Grid gap="0.5rem">
      ...
      <DataGridV3
        dataService={async (p) => poolTransactionApi.getItems(selectedItem.id, p)}
        columns={columns}
