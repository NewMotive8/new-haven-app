...
import PoolsTransactionsTab from './tabs/poolsTransactions'
...
export default function PoolsForm() {
  ...
  const formTabs: Array<TabSelectorTabI> = [
    {
      ...
      label: (
        <Typography
          ...
          translateKey="pools-info"
        />
      ),
      content: <BasicTab />,
    },
    {
      value: 'poolsTransactions',
      label: (
        <Typography
          translateGroup="forms-tabs-label"
          translateKey="Pools-Transaction"
        />
      ),
      content: <PoolsTransactionsTab />,
    },
  ]
  ...
  const tabsHelper: { [key in any]: React.ReactNode } = {
    basic: textTranslated({
      ...
      key: 'pools-basic-tab-help',
      returnDefault: 'nothing',
    }),
    poolsTransactions: textTranslated({
      group: 'forms-tabs-helpers',
      key: 'pools-seedTransactions-tab-help',
      returnDefault: 'nothing',
    }),
  }
