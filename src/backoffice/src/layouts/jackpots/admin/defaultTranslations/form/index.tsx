...
export default function DefaulttranslationsForm() {
    const {
        selectedItem,
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="defaultTranslations-info" />,
            content: <BasicTab />,
        },
    ]

    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'defaultTranslations-basic-tab-help', returnDefault: 'nothing' }),
    }
