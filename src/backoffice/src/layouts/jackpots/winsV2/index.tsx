...
import winsApi, { winsV2I } from 'utils/services/api/requests/winsV2'
...
export default function WinsV2Crud() {
    const [loading, setLoading] = useState(false)
    const [selectedItem, setSelectedItem] = useState<winsV2I | null>(null)
    ...
    function submitForm() {
        setLoading(true)
        winsApi.submitForm(selectedItem as winsV2I, {
            successCallBack: () => {
                askRefresh()
                setSelectedItem(null)
                setLoading(false)
