...
import OptInTab from './tabs/opt-ins'
...
export default function PlayerForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="player-info" />,
            content: <BasicTab />,
        },
        {
            value: 'segments',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jpr-player-segments" />,
            content: <SegmentsTab />,
        },
        {
            value: 'optIns',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jpr-player-opt-ins" />,
            content: <OptInTab />,
        }
    ]

    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'player-basic-tab-help', returnDefault: 'nothing' }),
        segments: textTranslated({ group: 'forms-tabs-helpers', key: 'jpr-player-segments-tab-help', returnDefault: 'nothing' }),
        optIns: textTranslated({ group: 'forms-tabs-helpers', key: 'jpr-player-opt-ins-tab-help', returnDefault: 'nothing' }),
    }
