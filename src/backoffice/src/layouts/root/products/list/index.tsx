    ...
    return (
        <>
            <Grid horizontalAlgin="flex-end" margin="mb-3">
                <Button id="add-item-button" onClick={() => { setSelectedItem(productsApi.defaultItem) }} color="primary">
            ...
            <DataGridV3
                ...
                columns={columns}
                dataService={(p) => productsApi.getItems(p)}
                dataGridId={`products-${refreshState}`}
            />
        </>
    )
}
