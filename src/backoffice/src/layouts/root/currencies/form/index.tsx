...
export default function CurrenciesForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="currencies-info" />,
            content: <BasicTab />,
        },
    ]

    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'currencies-basic-tab-help', returnDefault: 'nothing' }),
    }
