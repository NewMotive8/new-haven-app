...
import CurrenciesCrudHeader from './header'
...
export default function CurrenciesCrud() {
    const [loading, setLoading] = useState(false)
    const [selectedItem, setSelectedItem] = useState<currenciesI | null>(null)
    ...
    function submitForm() {
        setLoading(true)
        currenciesApi.submitForm(selectedItem as currenciesI, {
            successCallBack: () => {
                askRefresh()
                setSelectedItem(null)
                setLoading(false)
