...
export default function PlayerForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        ...
        {
            value: 'segments',
            label: <Typography translateGroup="forms-tabs-label" translateKey="trr-player-segments" />,
            content: <SegmentsTab />,
        },
        {
            value: 'optIns',
            label: <Typography translateGroup="forms-tabs-label" translateKey="trr-player-opt-ins" />,
            content: <OptInTab />,
        }
    ]
    ...
    const tabsHelper: { [key in any]: React.ReactNode } = {
        ...
        segments: textTranslated({ group: 'forms-tabs-helpers', key: 'trr-player-segments-tab-help', returnDefault: 'nothing' }),
        optIns: textTranslated({ group: 'forms-tabs-helpers', key: 'trr-player-opt-ins-tab-help', returnDefault: 'nothing' }),
    }
