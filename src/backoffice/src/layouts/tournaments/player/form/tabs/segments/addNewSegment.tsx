...
export default function AddNewSegment(props: Props) {
    ...
    const { data: segments, isLoading, refetch } = useQuery(`trr-segments-player-${currentPlayer.id}`, () => segmentsApi.segmentsPerPlayer(currentPlayer.id), {})
    ...
    return (
        ...
        >
            <Grid>
                <Typography
                    translateGroup="trr-player-segments"
