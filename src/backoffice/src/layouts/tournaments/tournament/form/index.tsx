...
import TournamentRules from './tabs/rules'
import SegmentsTab from './tabs/segments'
import EventsTab from './tabs/events'
import InstanceCrud from 'layouts/tournaments/instance'
...
export default function TournamentRaceForm() {
    const {
        selectedItem,
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="tournamentRace-info" />,
            content: <BasicTab />,
        },
        {
            value: 'instances',
            label: <Typography translateGroup="forms-tabs-label" translateKey="tournamentRace-instances" />,
            content: <InstanceCrud tournamentId={selectedItem.id} />,
            hidden: !selectedItem.id,
        },
        {
            value: 'payouts',
            label: <Typography translateGroup="forms-tabs-label" translateKey="tournament-race-payouts" />,
            content: <RacePayouts />,
            hidden: !selectedItem.id,
        },
        {
            value: 'rules',
            label: <Typography translateGroup="forms-tabs-label" translateKey="tournament-race-rules" />,
            content: <TournamentRules />,
            hidden: !selectedItem.id,
        },
        {
            value: 'segments',
            label: <Typography translateGroup="forms-tabs-label" translateKey="tournament-race-segments" />,
            content: <SegmentsTab />,
            hidden: !selectedItem.id,
        },
        {
            value: 'events',
            label: <Typography translateGroup="forms-tabs-label" translateKey="tournament-race-events" />,
            content: <EventsTab />,
            hidden: !selectedItem.id,
        }
    ]
    ...
    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'tournament-race-basic-tab-help', returnDefault: 'nothing' }),
        instances: textTranslated({ group: 'forms-tabs-helpers', key: 'tournament-race-instances-tab-help', returnDefault: 'nothing' }),
        payouts: textTranslated({ group: 'forms-tabs-helpers', key: 'tournament-race-payouts-tab-help', returnDefault: 'nothing' }),
        segments: textTranslated({ group: 'forms-tabs-helpers', key: 'tournament-race-segments-tab-help', returnDefault: 'nothing' }),
        events: textTranslated({ group: 'forms-tabs-helpers', key: 'tournament-race-events-tab-help', returnDefault: 'nothing' }),
        tournamentRules: textTranslated({ group: 'forms-tabs-helpers', key: 'tournament-race-rules-tab-help', returnDefault: 'nothing' }),
    }
