...
export default function EventsForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="events-info" />,
            content: <BasicTab />,
        },
    ]

    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'events-basic-tab-help', returnDefault: 'nothing' }),
    }
