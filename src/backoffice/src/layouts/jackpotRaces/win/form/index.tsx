...
export default function WinForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="win-info" />,
            content: <BasicTab />,
        },
        {
            value: 'players',
            label: <Typography translateGroup="forms-tabs-label" translateKey="win-players" />,
            content: <PlayersTab />,
        }
    ]

    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'win-basic-tab-help', returnDefault: 'nothing' }),
        players: textTranslated({ group: 'forms-tabs-helpers', key: 'win-players-tab-help', returnDefault: 'nothing' }),
    }
