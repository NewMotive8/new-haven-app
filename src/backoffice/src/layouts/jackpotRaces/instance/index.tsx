...
import instanceApi, { instanceI } from 'utils/services/api/requests/jackpot-race-api/instance'
...
export default function InstanceCrud({ spinSprintId }: InstanceCrudProps) {
