...
import jackpotRaceApi, { jackpotRaceI } from 'utils/services/api/requests/jackpot-race-api/jackpotRace'
...
export default function JackpotraceCrud() {
    ...
    const [selectedItem, setSelectedItem] = useState<jackpotRaceI | null>(null)
    ...
    function submitForm() {
        setLoading(true)
        jackpotRaceApi.submitForm(
            selectedItem as jackpotRaceI, {
            successCallBack: () => {
                askRefresh()
                setSelectedItem(null)
                setLoading(false)
