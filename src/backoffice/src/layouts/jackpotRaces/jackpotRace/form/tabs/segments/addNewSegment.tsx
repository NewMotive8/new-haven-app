...
export default function AddNewSegment(props: Props) {
  ...
  const {
    ...
    () => segmentsApi.segmentsPerJackpotRace(currentJackpot.id as number),
    {},
  )
      ...
      onConfirm: () => {
        ...
        segmentsApi
          .bindSegmentToJackpot({
            spinSprintId: currentJackpot.id as number,
