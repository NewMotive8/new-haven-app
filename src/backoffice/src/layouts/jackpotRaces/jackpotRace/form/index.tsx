...
import InstanceCrud from 'layouts/jackpotRaces/instance'
import WidgetSettingsTab from 'layouts/jackpotRaces/jackpotRace/form/tabs/widget'
...
export default function JackpotraceForm() {
    ...
    const formTabs: Array<TabSelectorTabI> = [
        {
            value: 'basic',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jackpotRace-info" />,
            content: <BasicTab />,
        },
        {
            value: 'instances',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jackpotRace-instances" />,
            content: <InstanceCrud spinSprintId={selectedItem.id} />,
            hidden: !selectedItem.id,
        },
        {
            value: 'payouts',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jackpot-race-payouts" />,
            content: <RacePayouts />,
            hidden: !selectedItem.id,
        },
        {
            value: 'segments',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jackpot-race-segments" />,
            content: <SegmentsTab />,
            hidden: !selectedItem.id,
        },
        {
            value: 'events',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jackpot-race-events" />,
            content: <EventsTab />,
            hidden: !selectedItem.id,
        },
         {
            value: 'widget-settings',
            label: <Typography translateGroup="forms-tabs-label" translateKey="jackpot-race-widget-settings" />,
    ...
    const tabsHelper: { [key in any]: React.ReactNode } = {
        basic: textTranslated({ group: 'forms-tabs-helpers', key: 'jackpot-race-basic-tab-help', returnDefault: 'nothing' }),
        instances: textTranslated({ group: 'forms-tabs-helpers', key: 'jackpot-race-instances-tab-help', returnDefault: 'nothing' }),
        payouts: textTranslated({ group: 'forms-tabs-helpers', key: 'jackpot-race-payouts-tab-help', returnDefault: 'nothing' }),
        segments: textTranslated({ group: 'forms-tabs-helpers', key: 'jackpot-race-segments-tab-help', returnDefault: 'nothing' }),
        events: textTranslated({ group: 'forms-tabs-helpers', key: 'jackpot-race-events-tab-help', returnDefault: 'nothing' }),
        widgets: textTranslated({ group: 'forms-tabs-helpers', key: 'jackpot-race-widget-settings-tab-help', returnDefault: 'nothing' }),
    }
