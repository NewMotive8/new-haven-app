/* sockjs-client v1.6.1 | http://sockjs.org | MIT license */ ! function (e) {
  ...
  return function i(s, a, l) {
              ...
              (function () {
                  ...
                  e(u, a), u.prototype.abort = function () {
                      ...
                      if (r.id = "a" + i.string(8), r.src = e, r.type = "text/javascript", r.charset = "UTF-8", r.onerror = this._scriptError.bind(this), r.onload = function () {
                          ...
                          if (s.isOpera()) (t = this.script2 = c.document.createElement("script")).text = "try{var a = document.getElementById('" + r.id + "'); if(a)a.onerror();}catch(x){};", r.async = t.async = !1;
                          else {
                              try {
      ...
      50: [function (e, t, n) {
          "use strict";
          var i = e("crypto"),
              s = "abcdefghijklmnopqrstuvwxyz012345aaaaa";
          t.exports = {
              string: function (e) {
                  for (var t = s.length, n = () => {
                      if (typeof i.randomBytes === "function") {
                          return i.randomBytes(e)
                      }
                      return Math.random()
                  }, r = [], o = 0; o < e; o++) r.push(s.substr(n[o] % t, 1));
                  return r.join("")
              },
              number: function (e) {
      ...
      57: [function (e, n, t) {
          (function (a) {
              (function () {
                  ...
                  function g(e) {
                      var t, n = ("undefined" != typeof window ? window : void 0 !== a ? a : "undefined" != typeof self ? self : {}).location || {},
                          r = {},
                          o = typeof (e = e || n);
                      if ("blob:" === e.protocol) r = new _(unescape(e.pathname), {});
                      else if ("string" == o)
                          for (t in r = new _(e, {}), s) delete r[t];
                      else if ("object" == o) {
